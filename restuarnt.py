...
lblInfo=Label(Tops,font=('arial',50,'bold'),text="KHALEEL'S RESTAURANT ",fg="Steel Blue",bd=10,anchor='w')
...
lblTea= Label(f1, font=('arial', 16, 'bold'),text="Tea(5)",bd=16,anchor="w")
...
lblDrinks= Label(f1, font=('arial', 16, 'bold'),text="Drinks(20)",bd=16,anchor="w")
...
lblIceCream= Label(f1, font=('arial', 16, 'bold'),text="Ice-Cream(30)",bd=16,anchor="w")
...
lblIdly= Label(f1, font=('arial', 16, 'bold'),text="Idly(25)",bd=16,anchor="w")
...
lblDosa= Label(f1, font=('arial', 16, 'bold'),text="Dosa(25)",bd=16,anchor="w")
...
lblPulav= Label(f1, font=('arial', 16, 'bold'),text="Rice-Plate(50)",bd=16,anchor="w")
